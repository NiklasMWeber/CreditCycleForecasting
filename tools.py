...
def plotTable(data, rowList = None,colList = None, colName = None, rowName = None, type = None, Qflag = False, trueM = None):
    ...
    if Qflag == True:
        ...
        ax.set_ylabel(colName, fontsize=13)
        ax.set_xlabel(rowName, fontsize=13)
        #the_table.scale(1.3, 1.5)
        #the_table.colWidths = np.ones((len(colList)))/(len(colList))
    else:
        the_table.set_fontsize(13)
        ax.set_ylabel(colName, fontsize=15)
        ax.set_xlabel(rowName, fontsize=15)
